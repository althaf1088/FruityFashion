package com.example.fruityfashion.utils;
...
public class RequestHandler {
		...
		if(isBody)
			...
			try {
		       ...
		       /* List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(2);
		        nameValuePairs.add(new BasicNameValuePair("retailerId", "MerchantA1"));*/
	...
	public InputStream connectImage(String type, String url){
		isBody=false;
		response= new Response();
		try {
			httpClient = new DefaultHttpClient();
